...
function SkilledWorker() {
  return (
    <section className="skilled-worker-section position-relative">
      ...
      <div className="container-fluid skilled-worker-row d-flex flex-wrap">
        <div className="image-col">
          <img
            src="https://blaban.net/data/files/final-922_0000_final-930.png"
            alt="Skilled Worker"
            className="img-fluid skilled-worker-image"
          />
        </div>
        ...
        <div className="content-col d-flex align-items-center">
          <div className="skilled-worker-content text-white">
            ...
            <button className="custom-btn">Visit us</button>
          </div>
        </div>
      </div>
    </section>
